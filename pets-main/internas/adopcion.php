...
<div class="contenedor">
	...
	<main>
		...
		<form method="post" action="procesar.php"> <!--seguridad de datos-->
			...
			<div class="grupoInput">
				<label for="fechanacimiento">Fecha nacimiento</label> <!--el for sirve para ligar, se coloca el mismo nombre-->
				<input type="date" name="fechanacimiento" id="fechanacimiento" placeholder="Ingrese su fecha de nacimiento">
			</div>
			<div class="grupoInput">
				<label for="cedula">Cedula</label> <!--el for sirve para ligar, se coloca el mismo nombre-->
